...
def RunVCFSimPixy(seed):
    ...
    vcfsimprompt1 = 'bgzip ' + vcfsim
    vcfsimprompt2 = 'tabix ' + vcfsim + '.gz' 
    vcfsimprompt3 = 'pixy --stats pi --populations populations.txt --vcf ' + vcfsim + '.gz --window_size 10000 --n_cores 2'
...
def ConversionPixy(seed):
    ...
    os.system('bgzip modified_msprime.vcf')
    os.system('tabix modified_msprime.vcf.gz')
    os.system('pixy --stats pi --populations populations.txt --vcf modified_msprime.vcf.gz  --window_size 10000 --n_cores 2 --bypass_invariant_check yes')
...
runMultipleVCFToolsVCFSim(1000, 11001)
#runMultiplePixyVCFSim(1000, 6000)
